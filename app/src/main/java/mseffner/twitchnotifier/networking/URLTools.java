...
public class URLTools {
    ...
    public static String getTopStreamsUrl() {
        return Uri.parse(TWITCH_API_BASE_URL).buildUpon()
                ...
                .appendQueryParameter(PARAM_FIRST, "75")
                .build().toString();
    }
    ...
    public static long[][] splitIdArray(long[] array) {
        ...
        100, it will return an incomplete result. The true limit is more like 75.
        This was tested on March 30, 2018. */
        int chunkSize = Integer.parseInt(FIRST_MAX) - 25;
